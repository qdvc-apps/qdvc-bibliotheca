...
from .gtk3_md_highlight import MarkdownHighlighter  # noqa: E402
from .gtk3_widgets import (  # noqa: E402
    img_menu_item as _img_menu_item,
    pango_style_normal as _pango_style_normal,
    pango_style_italic as _pango_style_italic,
...
class CatalogueTab(Gtk.Box):
    ...
    def _edit_work_object(self, work, key=None):
        from .gtk3_myworks_editor import MyWorkEditor
